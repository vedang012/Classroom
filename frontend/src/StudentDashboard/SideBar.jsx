    ...
    return (
        <div className="sidebar w-72 border-r-2 flex flex-col">
            <div className="menu w-full flex flex-col  space-y-5 mt-3 pr-3">
                ...
                <button className='text-left hover-color flex flex-row items-center' onClick={openTodoModal}> <LuListTodo className='mr-3'/> To-Do</button>
                <button className='text-left hover-color flex flex-row items-center'> <CiBookmark className='mr-3'/>Saved items</button>
                ...
                <Modal isOpen={isTodoModalOpen} onClose={closeTodoModal}/>
